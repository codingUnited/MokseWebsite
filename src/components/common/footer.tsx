  ...
  return (
    <footer>
      {current !== "base" && current !== "sm" ? (
        ...
        <Container h={'50vh'} fluid pt={24} justifyContent={'space-between'} px={8}>
            ...
            <VStack alignItems={'left'}>
              ...
              <ChakraLink asChild >
                <NextLink href="mailto:info@mokse.org" target="_blank" rel="noopener noreferrer" >
                  <IconButton variant={'outline'} border={'lg'} borderRadius={'full'} size={'lg'} color={'teal.focusRing'} p={2} aria-label="Facebook">
                    <Icon asChild size={"md"} fill={'white'} color={'teal.focusRing'}>
                      <MdMail />
                    </Icon>
                  </IconButton>
                </NextLink>
          ...
          <VStack>
            <Heading as="h2">
              <Text textStyle={"lg"} textAlign={'start'} _light={{ color: "white" }} className={poppins.className} clear={'both'}>
                Quick Links
              </Text>
            </Heading>
            <VStack alignItems={'left'}>
          ...
          <VStack>
            ...
            <address>
              <HStack> <Text asChild color='teal' height={6} width={6} ><MdLocationPin /></Text> <p>497 Hooksett Road, Suite 362, Manchester, NH 03104</p></HStack>
